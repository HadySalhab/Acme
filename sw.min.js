(function(){const staticCacheName='static';const version='v1::';const OFFLINE_URL='https://hadysalhab.github.io/off/';function updateStaticCache(){const urls=['https://hadysalhab.github.io/','https://hadysalhab.github.io/manifest.json','/Acme/css/index.min.d534e44c68ef56bcd2604c4c607bfc5b7aa3c4056146f348ebf35714429e311009eb94bde30e3efe570536e573dbeeb247afc6f51c7917cb02d8e1391a3abc03.css','/Acme/index.min.js','https://hadysalhab.github.io/Acme/image/background.svg','https://hadysalhab.github.io/Acme/image/background-dark_huacd336bfb7f5597695f9c32d4115a2aa_1561823_1400x787_fill_q75_box_smart1.jpg',OFFLINE_URL,'https://hadysalhab.github.io/Acme/image/logo.min.svg','https://hadysalhab.github.io/index.json'];return caches.open(version+staticCacheName).then((cache)=>cache.addAll(urls)).catch(e=>{console.log("Error = ",e);console.log(e.stack);});}
